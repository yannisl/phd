...
\def\image#1#2#3#4\par{%
   ...
   \begin{wrapfigure}{#1}[0pt]{#2} % specify width only
    %\fbox{%
   \if#1l \def\leftjustified{} 
       \else 
    \def\leftjustified{\hfill\hfill}
    \fi
   \begin{minipage}[t]{#2}
      \leftjustified\includegraphics[width=#2]{./graphics/book.jpg}
     \caption[figure]{#3}
   \end{minipage}%}
   \end{wrapfigure}
#4\par}
...
\includegraphics{piero}


\includegraphics{vision}
...
\includegraphics[width=0.32\textwidth]{droveon}

\columnbreak
\fbox{\includegraphics[width=\linewidth]{billbryson02}}
\end{multicols}
\bottomline
...
\input{./manual/graphics}
\input{./manual/introduction}  % the preamble
\input{./manual/paragraphs}
\input{./manual/fonts}
\input{./manual/languages}
\input{./manual/boxesandglue}
\input{./manual/grouping}
\input{./manual/verse}

\input{./manual/charting01}
\input{./manual/docjavascript}
\input{./manual/captions}


\newgeometry{left=2cm,right=2cm}
\part{PROGRAMMING}
\input{./manual/macros}
\input{./manual/iteration}
\input{./manual/futurelet}
\input{./manual/expandafter}
\input{./manual/usefulmacros}

\input{./manual/datastructures}
%\input{./manual/numbers}
\input{./manual/classes}
...
\input{./manual/characters}
\input{./manual/diacritics}

\input{./manual/bibliographies}
...
%\input{./manual/pages}  Gives problems
\input{murals}
...
\input{./manual/wrapfig-02} % main chapter on wrapfig
...
\input{./manual/subfigure}   % use of subfigures  brekas read hyperef
