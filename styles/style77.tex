...
\def\cows{\raisebox{1sp}{\hbox{\includegraphics[width=\textwidth]{cows}}}}
\cxset{style77/.style={
chapter opening=any,
toc image =,
 name=,
 ...
 number dot=,
 number after=\hfill\hfill\par\hbox to \textwidth{\hfill \vrule height1pt width3cm \hfill}\vspace*{15pt}\par,
 number position=rightname,
 chapter font-family= sffamily,
 chapter font-weight=mdseries ,
 chapter font-size= large,
 chapter color=black!90,
 chapter before=\cows\par,
...
\chapter[Template 77]{The Death of Patroclus}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{trojan-war}
\end{figure}
...
%https://books.google.ae/books?id=8NSZP5XOR0MC&printsec=frontcover&dq=Houghton+Mifflin+Harcourt+:pdf&hl=en&sa=X&ei=pDX_VK21DIT7UOSogYgK&ved=0CDgQ6AEwBTg8#v=onepage&q&f=false
