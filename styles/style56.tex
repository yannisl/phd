...
\renewsubsection          
 \cxset{
  author block=true,
 author block format=\par\Large\aegean,
...
\def\authorblockformatcenter{}
 \cxset{
 author block=true,
 author block format=,
 author names={Donny George, Stony Brook University, with McGuire Gibson, Oriental Institute University of Chicago},}
