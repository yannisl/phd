...
\cxset{chapter opening=anywhere,
          yshift=-3.0cm,chapter toc=false, fill=olive}
\chapter{A test}
%\cxset{chapter opening=anywhere,
%          fill=olive,
%          yshift=-18cm}
...
\item If the template requires positioning of pictures and text at exact positions, you can use the 
        \pkg{picture} environment and the built-in commands provided in this package.
\item If it requires any special graphics, coloured blocks and the like, use the \pkg{TikZ} package or \pkg{pstricks}.
