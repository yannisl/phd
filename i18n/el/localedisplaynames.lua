  ...
  main = {
    el =  {
      ...
      localeDisplayNames =  {
        ...
        types =  {
          numbers =  {
            arab =  "Αραβικό_Ινδικά ψηφία",
            arabext =  "Εκτεταμένα αραβικό_ινδικά ψηφία",
          ...
          collation =  {
            big5han =  "Σειρά ταξινόμησης Παραδοσιακών Κινεζικών _ Big5"
          },
          numbers =  {
            brah =  "brah"
          },
          ...
          calendar =  {
            ...
            ethiopic_amete_alem =  "Αιθιοπικό ημερολόγιο Άμετ Άλεμ"
          },
          numbers =  {
          ...
          collation =  {
            gb2312han =  "Σειρά ταξινόμησης Απλουστευμένων Κινεζικών _ GB2312"
          },
          numbers =  {
          ...
          calendar =  {
            ...
            islamic_civil =  "Ισλαμικό αστικό ημερολόγιο",
            islamic_rgsa =  "Ισλαμικό ημερολόγιο (Σαουδική Αραβία, θέαση)",
            islamic_tbla =  "Ισλαμικό ημερολόγιο (δομημένο, αστρονομική εποχή)",
            islamic_umalqura =  "islamic_umalqura",
            iso8601 =  "Ημερολόγιο ISO_8601",
          ...
          colAlternate =  {
            non_ignorable =  "Ταξινόμηση συμβόλων"
          },
          numbers =  {
            olck =  "olck",
            orya =  "Οριγικά ψηφία",
