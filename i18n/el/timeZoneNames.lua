local main = main or {}
  main =  {
    el =  {
      ...
      dates =  {
        timeZoneNames =  {
          hourFormat =  "+HH=mm;_HH=mm",
          gmtFormat =  "GMT{0}",
          gmtZeroFormat =  "GMT",
          regionFormat =  "Ώρα ({0})",
          regionFormat_type_standard = "Χειμερινή ώρα ({0})",
          regionFormat_type_daylight = "Θερινή ώρα ({0})",
          fallbackFormat =  "[{1} ({0})]",
          zone =  {
            America =  {
              Adak =  {
              ...
              Lower_Princes= {
                exemplarCity =  "Lower Prince’s Quarter (Άγιος Μαρτίνος Ολλανδίας)"
              },
              Maceio =  {
                exemplarCity =  "Μασέιο"
              },
          ...
          metazone =  {
            ...
            Hawaii_Aleutian= {
              long =  {
                generic =  "Ώρα Χαβάης_Αλεούτιων νήσων",
                standard =  "Χειμερινή ώρα Χαβάης_Αλεούτιων νήσων",
                daylight =  "Θερινή ώρα Χαβάης_Αλεούτιων νήσων"
              }
            },
            Hong_Kong= {
              long =  {
            ...
            Kamchatka =  {
              long =  {
                ...
                standard =  "Χειμερινή ώρα Πετροπαβλόβσκ_Καμτσάτσκι",
                daylight =  "Θερινή ώρα Πετροπαβλόβσκ_Καμτσάτσκι"
              }
            },
            Kazakhstan_Eastern= {
              long =  {
            ...
            Mexico_Northwest= {
              long =  {
                generic =  "Ώρα Βορειοδυτικού Μεξικού",
                standard =  "Χειμερινή ώρα Βορειοδυτικού Μεξικού",
                daylight =  "Θερινή ώρα Βορειοδυτικού Μεξικού"
              }
            },
            Mexico_Pacific= {
              long =  {
