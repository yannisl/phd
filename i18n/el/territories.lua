    ...
    el =  {
      ...
      localeDisplayNames =  {
        territories =  {
          ...
          CD =  "Κονγκό _ Κινσάσα",
          CD_alt_variant = "Κονγκό",
          CF =  "Κεντροαφρικανική Δημοκρατία",
          CG =  "Κονγκό _ Μπραζαβίλ",
          CG_alt_variant = "Κονγκό (Δημοκρατία)",
          CH =  "Ελβετία",
          ...
          FJ =  "Φίτζι",
          FK =  "Νήσοι Φόκλαντ",
          FK_alt_variant = "Νήσοι Φόκλαντ (Νήσοι Μαλβίνας)",
          FM =  "Μικρονησία",
          FO =  "Νήσοι Φερόες",
          FR =  "Γαλλία",
          GA =  "Γκαμπόν",
          ...
          MK_alt_variant = "Πρώην Γιουγκοσλαβική Δημοκρατία της Μακεδονίας (ΠΓΔΜ)",
          ML =  "Μάλι",
          MM =  "Μιανμάρ/Βιρμανία",
          MN =  "Μογγολία",
          MO =  "Μακάο ΕΔΠ Κίνας",
          ...
          TK =  "Τοκελάου",
          TL =  "Τιμόρ_Λέστε",
          TL_alt_variant = "Ανατολικό Τιμόρ",
          TM =  "Τουρκμενιστάν",
          TN =  "Τυνησία",
          TO =  "Τόνγκα",
          TR =  "Τουρκία",
