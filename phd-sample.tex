\listfiles
\documentclass[book, 12pt]{phd}
\makeatletter
\RequirePackage[OT1]{fontenc}
\RequirePackage[numbers]{natbib}
\usepackage{centernot}
\makeatletter
\cxset{document type = book}
...
\cxset{plain sections/.style={
       ...
       section numbering prefix =\thechapter.,%use \thechapter. for books or add as option
...
% Chapter Settings
 ...
 chapter opening = right, % any,right,left,none
 chapter numbering = WORD,
 chapter font-family= sffamily,
 chapter font-weight= bold,% use bfseries, bold,
