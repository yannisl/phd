...
\usepackage{csquotes}
\usepackage[citestyle=verbose-ibid, bibstyle=authoryear, backend=biber, labeldate=year]{biblatex}
\usepackage{hyperref}
...
\begin{document}
  ...
  Let's\footcite{baez/article} cite\footcite{grice} an\footcite{grice} article\footcite{huang}, now\footcite{grice} this\footcite{grice}.\footcite{xspace}
