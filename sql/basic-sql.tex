...
My suggestion when you start is to use an open source database such as SQLITE3. Most of the open source RDMS provide utilities for generating databses via a console. 
