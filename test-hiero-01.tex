...
\begin{luacode*}
   ...
   h.printhierochar("aegyptus","13003",{direction="LR",
                                        color = "teal",
                                        scale = 1})
   h.parseMdC("M23-X1-R4-X8-Q2-D4-W17-R14-G4-R8-O29-V30-U23-N26-D58-O49-Z1-F13-N31-V30-N16-N21-Z1-D45-N25!")
...
\printhierochar[direction="RL",
                color = "teal",
                scale = 7]{"aegyptus"}{"13051"}
\kern-5mm
\printhierochar[direction="LR",
                color = "teal",
                scale = 7]{"aegyptus"}{"13003"}
