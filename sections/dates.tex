...
One can get the current system date using \cmd{today}
...
\tex offers only one macro \cmd{time} which is the time in hours since midnight.
...
\noindent\texttt{\printf{\textbackslash setdate  \thedatenumber}}
