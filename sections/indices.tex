...
the index, we should use the command |\index{Kroll}|.\index{Kroll}

If the word is to be printed in bold, we use


\index{Kroll=\textbf{Kroll}}\index{Kroll>Leon Kroll}
...
The command |\Zs{\ta}| typesets the command in the document, as (\Zs{\ta}) and also adds it to the index and typesets the symbol.
...
\index{{tibetan>astronomical signs>\protect\tibetan ༃}}
