...
\CMDI{\makebox}\oarg{width}\oarg{position}\marg{contents} is \latex's box workhorse.
...
\begin{macro}{\parbox}\oarg{position}\oarg{height}\oarg{innerpos}\marg{width}\marg{contents} 
