...
to define boolean switches
 ...
 to -1. This is really an esoteric trick.
...
The \cmd{\newif} is defined in a very clever way.  At line [\ref{atif}] it receives two arguments
the |\iftest| and |\iffalse|
...
This is a mind twisting way to define the |\newif| and it would get I am sure would be applauded by every Byzantine
General. It also resolved a long standing query in my head as to why there was never a |@gobblethree| command in the
kernel  (see \autoref{gobble}).
...
This been a rather long discussion, but this is almost the heart of the kernel commands taht are most useful
