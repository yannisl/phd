...
\begin{tablenote}
  ...
  \cmdI{\oldstylenums}\verb|{|$\ldots$\verb|}| to typeset an old-style eg. abcde\oldstylenums{123456789}fgh.
  number.
\end{tablenote}
\end{symtable}
...
% \noindent\DescribeMacro{\widetriangle}\DescribeMacro{\wideparen}
% 
% $$
% \widehat{A}, 
% \widehat{AB},
