...
\contentsline {chapter}{\chapternumberline {1}{Paragraphs and Lists}{}}{1}{section*.2}
\contentsline {section}{\numberline {1}Typesetting paragraphs}{1}{section.1.1}
\contentsline {section}{\numberline {2}First line indentation and paragraph separation}{2}{section.1.2}
\contentsline {section}{\numberline {3}Block paragraph}{2}{section.1.3}
\contentsline {subsection}{\numberline {3.1}Hanging paragraphs}{2}{subsection.1.3.1}
\contentsline {section}{\numberline {4}Centering lines}{3}{section.1.4}
\contentsline {section}{\numberline {5}Flush and Rugged}{4}{section.1.5}
\contentsline {section}{\numberline {6}Centered text}{4}{section.1.6}
\contentsline {section}{\numberline {7}Other paragraph styles}{5}{section.1.7}
\contentsline {section}{\numberline {8}everypar}{5}{section.1.8}
\contentsline {section}{\numberline {9}Double spacing}{6}{section.1.9}
\contentsline {section}{\numberline {10}Controlling the width of a paragraph}{6}{section.1.10}
\contentsline {subsection}{\numberline {10.1}Minipages}{7}{subsection.1.10.1}
\contentsline {section}{\numberline {11}obeylines}{7}{section.1.11}
\contentsline {section}{\numberline {12}Narrowing paragraphs}{9}{section.1.12}
\contentsline {section}{\numberline {13}Shaping paragraphs with shapepar}{10}{section.1.13}
\contentsline {section}{\numberline {14}Summary}{10}{section.1.14}
\contentsline {section}{\numberline {15}Linenumbers}{11}{section.1.15}
\contentsline {section}{\numberline {16}Dangerous bends}{11}{section.1.16}
\contentsline {section}{\numberline {17}French spacing}{12}{section.1.17}
\contentsline {section}{\numberline {18}Code tables}{13}{section.1.18}
\contentsline {chapter}{\chapternumberline {2}{Hyphenation}{}}{15}{section*.3}
\contentsline {section}{\numberline {1}Hyphenation exceptions}{19}{section.2.1}
\contentsline {section}{\numberline {2}Testing badness}{22}{section.2.2}
\contentsline {section}{\numberline {3}The line breaking problem}{22}{section.2.3}
\contentsline {section}{\numberline {4}Patents and other research}{23}{section.2.4}
\contentsline {section}{\numberline {5}Typesetting with varying letter widths}{24}{section.2.5}
\contentsline {section}{\numberline {6}The strangeness of TeX}{24}{section.2.6}
\contentsline {section}{\numberline {7}The Gutenberg Bible}{24}{section.2.7}
\contentsline {section}{\numberline {8}Life is not always simple}{26}{section.2.8}

Paragraphs represent a distinct logical step within the whole argument expounded in section of a document. The \texttt{Tufte-book} class has a control sequence that is named \cs{newthought} to reinforce the idea that a paragraph must start with a new thought or argument. How does this particular paragraph contribute to the argument? 
...
We can even make paragraphs doubly narrow by using \cs{narrower} \cs{narrower} in example \ref{narrow}.
