...
\makeatletter
\@specialtrue
\tikzset{dim/.style={color=black!25,thick,>=stealth,}}^^A
\def\labelit{^^A
{\tikz[remember picture]\draw[dim,<-|,overlay] (0,0)--++(0,0.8)--++(1,0) node[right,fill=blue!15,text=black] {textii};}^^A
}^^A
\def\labelitt#1{^^A
...
\fi%
\labelitt{figure}
\hskip\offsetx\begin{minipage}[t]{\textwidth}^^A
