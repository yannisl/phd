...
\includegraphics[width=\textwidth]{./graphics/rosenberg.jpg}\par
\addcredit{U.S. DoD.}
...
\begin{figure}[htp]
\captionsetup{name=Fig., labelsep=period, format=plain, margin{0pt,0pt}}%
\includegraphics[width=\textwidth]{./graphics/movingup.jpg}\par
\addcredit{U.S. DoD}%
