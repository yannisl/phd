...
\begin{macro}{\and} The \cmd{\and} is used to join the names of authors and to place them in a tabular!
       \begin{teX}
...
\begin{macro}{\@dottedtocline}\meta{level}\meta{indent}\meta{numwidth}%
...
styles. Our own \pkgname{phd} provides a flexible ssytem with all the parameters provided as key value pairs based on pgf keys. By far the most popular package is Javier Bezos \pkgname{titlesec}. This forms part of a suite of
