...
Note that the command provide by \texttt{ifthen} \doccmd{setboolean} takes true or false, as \#2, and sets \#1 accordingly. In the above code we set the option as true. 
