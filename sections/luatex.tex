...
The first thing you will need to program, when developing a \LuaTeX\ package, is to check that the engine is in fact using \LuaTex. This can be done using the \cmd{\ifluatex} from the package \pkgname{ifluatex}. 
