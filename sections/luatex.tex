...
Another limitation is \tex's math capabilities. One can just marvel at the efforts of \tex macro authors in achieving what they have achieved. A cursory look at the code in the \pkgname{fp} package \cite{fp} can give you an idea of the difficulties and complexities involved. The similar package by the \latex3 Team is another gigantic and amazing production.
...
\let\exec\directlua
\begin{texexample}{repeat until}{ex:repeat}
\exec{
  N,Z=1,21
  F=1
  repeat
