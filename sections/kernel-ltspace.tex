...
\begin{macro}{\nopagebreak} The command\cs{nopagebreak}\oarg{i} : \meta{i} = 0,...,4 attempts to stop the page breaking at this point, by inserting an appropriate amount of penalty. It also takes care to avoid introducing redundant spaces. It does not always work as advertized.
\end{macro}
...
also a robust version available \CMDI{\protected@testopt}.
...
%
%
\begin{macro}{\newline}\index{LaTeX kernel>spacing>\string\newline}
