...
\hskip-0.9cm\includegraphics[width=1.03\textwidth]{./images/twowomen-03.png}\\[-27.5pt]
...
\includegraphics[width=1.03\textwidth]{./images/threewomen01.png}\par\vspace*{-8pt}%
