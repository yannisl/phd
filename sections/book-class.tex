...
\paragraph{Chapter}. The chapter definition follows, the same pattern as that of the part definitions. It calls \refCmd{secdef} and defines commands for the starred and un-starred versions.
...
The \refCmd{fboxsep} and \refCmd{fboxrule} are then set to |3pt| and |.4pt| respectively. These are used with frame boxes.
