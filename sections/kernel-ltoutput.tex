...
the figure as well as the table environments. It is instructive to start the discussion of the algorithm from this point. The class defines the default float placement specifier using 
|\fps@figure| and then goes on to define the figure environment with the help of |\@float| and |\@endfloat|, which are defined in the generic float.dtx in the kernel.
...
\begin{tabular}{rl}
{\fboxsep2pt \LARGE  \fbox{1} \fbox{1} \fbox{0} \fbox{0} \fbox{1} \fbox{0}} &= 50\\
{\fboxsep2pt\LARGE \fbox{1} \fbox{0} \fbox{1} \fbox{0} \fbox{0} \fbox{1} \fbox{0}} &= 82
\end{tabular}
...
\setcounter{topnumber}{2}
 ...
 \begin{macro}{\topfraction}\label{topfraction}
