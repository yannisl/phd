...
\caption{A typical Abbreviations page. This has been extracted from \citep{bacchae}.}
\end{figure}


\section{The indefinite article with abbreviations}

The choice between \textit{a} and \textit{an} before an abbreviation depends on pronunciation,
not spelling. Use a before abbreviations beginning with a
consonant sound, including an aspirated h and a vowel pronounced with
the sound of w or y.
...
\begin{texexample}{SI Units}{siunits}
\SI{100}{\mebi\byte} \\
