...
\cxset{manet/.style={
 ...
 number font-family=,
 number font-weight=,
 number before={\vspace*{\dimexpr(-1in-(\topmargin+\headsep+\headheight+\topskip+3pt))\relax}},
 number dot={},
 number after={},
 ...
 title beforeskip={},
 title afterskip={},
 title before={\hskip-2.3cm\includegraphics[width=1.3\paperwidth]{./chapters/manet}\par
...
\def\topimage#1{\cxset{title before={\hspace*{\dimexpr(-1in-\oddsidemargin-\marginparsep)\relax}
\includegraphics[width=\paperwidth]{./chapters/#1}\par
