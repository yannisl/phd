...
%\newgeometry{top=.5cm,left=3cm,right=3cm,headheight=1cm,headsep=0.5cm,marginpar=3.6cm,
%marginparsep=10pt}
...
\coordinate (text1) at (1in+\oddsidemargin,\paperheight-1in-\headsep-\headheight);
% draw paper
...
% oddside margin
\draw [color=blue] (1in+\oddsidemargin, \paperheight-1in-\headsep-\headheight) -- ++ (0,-\textheight);
% marginpar
\draw [color=blue] (1in+\oddsidemargin+\textwidth+\marginparsep,\paperheight-1in-\headsep-\headheight ) rectangle ++(\marginparwidth,-\textheight);
\end{tikzpicture}
