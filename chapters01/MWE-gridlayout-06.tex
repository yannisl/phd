...
\cxset{geometry diagonal=none,
          ...
          geometry label color=purple!15,
          geometry grid color=teal!15,
...
%		draw headsep
      \draw [dim,|<->|](\tol,\paperheight-1in-\topmargin-\headheight)-- ++(0,-\headsep) node[above right,fill=\geometrycolor@cx] at ++(1ex,0){\labelit@cx{\headsep}};

\fi
%		draw dim textheight
      \draw [dim, |<->|](\tol,\paperheight-1in-\topmargin-\headheight-\headsep)
               -- ++(0,-\textheight) node[right,text width=2.1cm,text centered,fill=\geometrylabelcolor@cx] at ++(1ex,0.5\textheight){\labelit@cx{\textheight}};
...
\else
    \draw [dim, |<->|](\tol,\paperheight-1in-\topmargin-\headheight-\headsep-\textheight)
               -- ++(0,-\footskip)
               node[right,fill=blue!15] at ++(1ex,0.5\footskip){\labelit@cx{\footskip}};
\fi
...
%	bottom fraction
\ifbotfloat{%
\draw [dim,|<->|] (1in+\innermargin-0.8cm, \paperheight-1in-\topmargin-\headheight-\headsep) ++(0,-\textheight) -- ++(0,\bottomfraction\textheight) node[left, text width=1.5cm, fill=\geometrylabelcolor@cx] at  ++(-1ex,-\bottomfraction*0.5\textheight){bottom\\ fraction\\ \bottomfraction};
% textfloatsep
...
\setlength\toly{1.5cm}
\draw[dim,|<->|](0,\toly)--++(1in,0)node [text width=1.0cm ,fill=\geometrylabelcolor@cx] at ++(-0.6in,-0.2em){driver marg.\\ 1\thinspace in};
