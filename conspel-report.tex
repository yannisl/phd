...
\newcommand\isFootnote{%
  ...
  \cxset{headings style/.style={headings odd header background color = white,
         ...
         %
         headings odd footer right = Conspel,
         headings even footer right = Conspel,
        ...
        % headings even footer right = shorttitle,
         ...
         headings odd footer right = halftitleleft}
  }
...
%introduction
\input{./conspel/introduction}
\input{./conspel/subcontracts}
\input{./conspel/manpower}
\end{document}
