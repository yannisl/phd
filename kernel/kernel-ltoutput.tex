...
|\fps@figure| and then goes on to define the figure environment with the help of \refCom{@float} and \refCom{end@float}, which are defined in the generic float.dtx in the kernel.
...
\begin{docCommand}{@outputpage}{\marg{void}}
