...
or unframed boxes.\tcbdocmarginnote{13/08/2017}
...
% \end{macro}
%
 \begin{docCommand}{mbox}{\marg{material}}
% \changes{v0.1a}{1993/12/03}
%         {extra group}
% \changes{v1.0j}{1994/10/18}
%         {\cs{long} added}
...
The following commands are basically inherited from plain \TeX. Note the us of |\@@line| to refer to the original
Plain \tex macros. 

\begin{docCommand}{leftline}{\marg{material}}
\end{docCommand}
\begin{teXXX}
