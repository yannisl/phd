...
\begin{docCmd}{DeclareFontShape}{ \marg{encoding}\marg{family}\marg{series}\marg{shape}\marg{loading-info} \marg{loading-settings}}
...
%
%
\begin{docCmd}{DeclareFixedFont}{ \marg{cmd}\marg{encoding}\marg{family}\marg{series}\marg{shape}\marg{size}}
...
%  \end{macro}
%
\begin{docCmd}{DeclareFontFamily}{ \marg{encoding}\marg{family}\marg{loading-settings}}
...
%
%
\begin{docCmd}{DeclareFontEncoding}{ \marg{encoding}\marg{text-settings}\marg{math-settings}}
...
%
%
 \begin{docCmd}{LastDeclaredEncoding}{}
...
\end{docCmd}
%
\begin{docCmd}{DeclareFontSubstitution}{ \marg{encoding}\marg{family}\marg{series}\marg{shape}}
...
%
%
\begin{docCmd}{DeclareFontEncodingDefaults}{}
\begin{teX}
...
%
%
\begin{docCmd}{DeclarePreloadSizes}{}
\begin{teX}
...
%
%
 \begin{docCmd}{mathversion}{ \marg{version}}
