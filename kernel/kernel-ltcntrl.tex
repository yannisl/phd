...
\latex. It must be emphasized that \pkg{expl3} did a tremendous job in providing
tens of alternatives in a more organized manner. If you need to program any serious amount of code
you are advised to move over to these. The \pkg{etoolbox} package\footcite{etoolbox} also provides many
...
\begin{docCmd}{@iwhilenum}{}
 Changes 
 \footnotechanges{v1.0f}{1995/07/09}{Reimplemented using Kabelschacht method}
 \footnotechanges{v1.0g}{1995/08/16}{Removed \cs{@whilenoop}}
 \footnotechanges{v1.0g}{1995/08/16}{Made defs long}
\begin{teX}
...
% \footnotechanges{v1.0f}{1995/07/09}{Reimplemented using Kabelschacht method}
% \footnotechanges{v1.0g}{1995/08/16}{Removed \cs{@whileswnoop}}
\begin{teX}
...
%
\begin{docCmd}{@nnil}{}
A quark to mark delimited macros. 
\begin{teX}
\def\@nnil{\@nil}
\end{teX}
\end{docCmd}
...
% \footnotechanges{v1.0g}{1995/08/16}{Made defs long}
% \footnotechanges{v1.0h}{2007/08/06}{Really make defs long}
\begin{teX}
\long\def\@fornoop#1\@@#2#3{}
\end{teX}
\end{docCmd}
%
\begin{docCmd}{@for}{\Arg{:}\Arg{=}\Arg{comma list}}
% \footnotechanges{v1.0d}{1995/04/24}
%      {Dont expand second argument with \cs{edef}: /1317 (DPC)}
Note that this is a macro delimited with |:=| and |\do|. After expanding |#2|
it handles control to |\@forloop| which takes over control. If you wandering why
|:=|, this was the |becomes| symbol used in Pascal and people were familiar with
the convention.
\begin{teX}
...
Note that it ignores any spaces in the list
\end{macro}
