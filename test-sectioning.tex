...
\draw [color=bgsexy, fill=bgsexy] 
  ([xshift=-35pt]current page.north east) rectangle (current page.south east);
\node[rotate=90,white,
      font=\Large\bfseries\arial,
      anchor=south east] 
       at ([shift={#2}]current page.north east) 
  {#1 \MakeTextUppercase{\rightmark}};
\end{tikzpicture}%
}

\makeatletter
\g@addto@macro\headhookleft{\ThumbIndex{AUTOMATED TESTS}{(-6pt,-20pt)}}
\makeatother
...
^^A     subsubsection format=hang,
 ...
 \cxset{hang}
 \section{This is a changed section }
 \lorem\lorem

 \subsection{This is a changed subsection }
 \lorem\lorem

 \subsubsection{This is a changed subsubsection}
 \lorem\lorem

 \paragraph{This is a changed paragraph.}
 \ExplSyntaxOn
 \lorem
 ...
 \cxset{chapter title margin-top-width=1cm,
...
\lorem\lorem
 ...
 \cxset{section arc=5mm,
        ...
        section title margin-top-width=0pt,
 }
 ...
 \cxset{
        ...
        chapter title margin-top-width=20pt, 
 }
