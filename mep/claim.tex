...
\cxset{name=Chapter, chapter toc=true,chapter numbering=arabic,number color=black,
...
\cxset{number font-style=upshape, number color=black, number padding-left=0.5em,
         chapter numbering=arabic, number spaceout=none,chapter spaceout=none, section align=left,
         section font-family=sffamily, section font-weight=bfseries,chapter opening=any, name=Chapter}
